...
chvrches_photo = open("https://vaporwave-seeds.s3.amazonaws.com/chvrches.jpeg")
chvrches.photo.attach(io: chvrches_photo, filename: "chvrches.jpeg")
the_weeknd = User.create(email: "the@week.nd", password: "123456", age: "30", gender: "Male", display_name: "The Weeknd")
the_weeknd_photo = open("https://vaporwave-seeds.s3.amazonaws.com/weeknd.jpeg")
the_weeknd.photo.attach(io: the_weeknd_photo, filename: "weeknd.jpeg")
...
childish_gambino_photo = open("https://vaporwave-seeds.s3.amazonaws.com/gambino.jpeg")
childish_gambino.photo.attach(io: childish_gambino_photo, filename: "gambino.jpeg")
nujabes = User.create(email: "nujabes@gmail.com", password: "restinpeace", age: "36", gender: "Male", display_name: "Nujabes")
nujabes_photo = open("https://vaporwave-seeds.s3.amazonaws.com/nujabes.jpeg")
nujabes.photo.attach(io: nujabes_photo, filename: "nujabes.jpeg")
porter = User.create(email: "porter@robinson.com", password: "robinson", age: "27", gender: "Male", display_name: "Porter Robinson")
porter_photo = open("https://vaporwave-seeds.s3.amazonaws.com/porter.jpeg")
porter.photo.attach(io: porter_photo, filename: "porter.jpeg")
gorillaz = User.create(email: "go@rillaz.com", password: "melancholy", age: "22", gender: "NA", display_name: "Gorillaz")
gorillaz_photo = open("https://vaporwave-seeds.s3.amazonaws.com/gorillaz.jpg")
gorillaz.photo.attach(io: gorillaz_photo, filename: "gorillaz.jpg")
test_user = User.create(email: "test@test.com", password: "hunter12", age: "25", gender: "NA", display_name: "TestUser")
test_user_photo = open("https://vaporwave-seeds.s3.amazonaws.com/test.png")
test_user.photo.attach(io: test_user_photo, filename: "test.png")
...
demo_song2_photo = open("https://vaporwave-seeds.s3.amazonaws.com/moow.jpeg")
demo_song2.photo.attach(io: demo_song2_photo, filename: "moow.jpeg")
demo_song2_song = open("https://vaporwave-seeds.s3.amazonaws.com/bad_mood.mp3")
demo_song2.song.attach(io: demo_song2_song, filename: "bad_mood.mp3")

demo_song3 = Song.create(title: "Satellite", artist_id: demo_user.id, genre: "Lo-fi", description: "North Pole")
demo_song3_photo = open("https://vaporwave-seeds.s3.amazonaws.com/north_pole.jpg")
demo_song3.photo.attach(io: demo_song3_photo, filename: "north_pole.jpg")
demo_song3_song = open("https://vaporwave-seeds.s3.amazonaws.com/satellite.mp3")
demo_song3.song.attach(io: demo_song3_song, filename: "satellite.mp3")
