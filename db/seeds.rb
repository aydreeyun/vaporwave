...
test_user = User.create(email: "test@test.com", password: "25", age: "25", gender: "NA", display_name: "TestUser")

demo_song1 = Song.create(title: "test", artist_id: demo_user.id, genre: "", description: "test")
demo_song1_song = File.open("/home/adrian/Desktop/test.mp3")
...
demo_song2_photo = File.open("/home/adrian/Desktop/north_pole.jpg")
demo_song2.photo.attach(io: demo_song2_photo, filename: "north_pole.jpg")
demo_song2_song = File.open("/home/adrian/Desktop/satellite.mp3")
...
demo_song3_photo = File.open("/home/adrian/Desktop/moow.jpeg")
demo_song3.photo.attach(io: demo_song3_photo, filename: "moow.jpeg")
demo_song3_song = File.open("/home/adrian/Desktop//bad_mood.mp3")
...
graves_photo = File.open("/home/adrian/Desktop/love_is_dead.jpg")
graves.photo.attach(io: graves_photo, filename: "love_is_dead.jpg")
graves_song = File.open("/home/adrian/Desktop/graves.mp3")
...
mother_we_share_photo = File.open("/home/adrian/Desktop/chvrches_bones.jpg")
mother_we_share.photo.attach(io: mother_we_share_photo, filename: "chvrches_bones.jpg")
mother_we_share_song = File.open("/home/adrian/Desktop/the_mother_we_share.mp3")
...
nineteen_ten_photo = File.open("/home/adrian/Desktop/3_15_20.png")
nineteen_ten.photo.attach(io: nineteen_ten_photo, filename: "3_15_20.png")
nineteen_ten_song = File.open("/home/adrian/Desktop/19_10.mp3")
...
in_your_eyes_photo = File.open("/home/adrian/Desktop/after_hours.jpg")
in_your_eyes.photo.attach(io: in_your_eyes_photo, filename: "after_hours.jpg")
in_your_eyes_song = File.open("/home/adrian/Desktop/in_your_eyes.mp3")
...
save_your_tears_photo = File.open("/home/adrian/Desktop/after_hours.jpg")
save_your_tears.photo.attach(io: save_your_tears_photo, filename: "after_hours.jpg")
save_your_tears_song = File.open("/home/adrian/Desktop/save_your_tears.mp3")
